python train_mesh_without_lbs_humanrf.py --save_name a1_s1_460_200 --downsample_view 1 --num_frames 200 \
 ...
 --start_idx 460 --exp_name humanrf_without_lbs_with_cloth \
 --wandb --wandb_entity lxxue --wandb_name a1_s1_460_200 --wandb_proj PhysAvatar